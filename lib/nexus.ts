...
explains what data is collected when you visit the site and how it is
handled.
...
- No email addresses are collected. The site does not run a mailing list.
- No cookies are set for tracking or advertising.
- No data is sold, rented, or shared with third parties for marketing.
- No third-party advertising networks are embedded on the site.
...
You may request a copy of any data held about you, or its deletion, by
writing to [hello@derb37.com](mailto:hello@derb37.com).
...
Jacqueline Ng unless otherwise credited. They are shared for personal,
non-commercial reading. You are welcome to cook the recipes for yourself,
your family, and your guests. Please don't republish, syndicate, or repost
the writing or photography elsewhere without asking. A short quote with a
link back is fine.
